  ...
  return (
    <div className="flex flex-col gap-2">
      ...
      <input
        id={inputId}
        className={cn(
          "h-11 w-full rounded-xl bg-blue-200 px-4 text-sm text-black-950 outline-none transition-all duration-200 placeholder:text-blue-400 focus:bg-blue-100 focus:ring-2 focus:ring-black-500 disabled:cursor-not-allowed disabled:opacity-50",
